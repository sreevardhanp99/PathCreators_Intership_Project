            ...
            <p align="justify">
                <center>
                    <center>VIEW DOCTORS</center>
                                ...
                                <td><center><%=r.getString("gender")%></center></td>
                                <td><center><%=r.getString("address")%></center></td>
                                     <%if(status.equals("waiting")){%>
                                     <td><center><a href="Activate_Doctor.jsp?id=<%=id%>">Activate</a></center></tD>  
                                    <% }else{
%>
